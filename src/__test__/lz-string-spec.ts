...
describe("Specific URL Encoded", () => {
  it("check that all chars are URL safe", () => {
    ...
    const compressed = LZString.compressToEncodedURIComponent(testString);
  ...
  it("check that + and ' ' are interchangeable in decompression", () => {
    ...
    const decomp2 = LZString.decompressFromEncodedURIComponent(compressed);
