...
const LZString: LZString = {
  compressToBase64 : function (input: string): string {
    ...
    const res: string = LZString._compress(input, 6, function(a){return keyStrBase64.charAt(a);});
  ...
  _compress: function (uncompressed, bitsPerChar, getCharFromInt): string {
    ...
    let i: number
    let value: number
    let context_dictionary: Dictionary = {}
    let context_dictionaryToCreate: PendingDictionary = {}
