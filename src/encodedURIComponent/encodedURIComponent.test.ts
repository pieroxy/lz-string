...
describe("encodedURI", () => {
    ...
    test(`+ and ' ' are interchangeable in decompression`, () => {
        ...
        expect(getTestData("tattoo")).toEqual(decompressFromEncodedURIComponent(test_tattooEncodedURIComponent));
        expect(getTestData("tattoo")).toEqual(decompressFromEncodedURIComponent(test_tattooEncodedURIComponentPlus));
    });
});
