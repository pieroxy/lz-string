...
import {
  ...
  test_repeat,
  test_tattooBase64,
  test_tattooEncodedURIComponent, test_tattooEncodedURIComponentPlus,
  test_tattooSource,
...
function runTestSet (desc, compressFunc, decompressFunc, compressedTattoo) {
  ...
  test(`${ desc } : null`, () => {
    ...
    const _ = (compressedNull instanceof Uint8Array)
  ...
  test(`${ desc } : empty string`, () => {
    ...
    const _ = (compressedEmpty instanceof Uint8Array)
  ...
  test(`${ desc } : undefined`, () => {
    ...
    const _ = (compressedUndefined instanceof Uint8Array)
...
runTestSet('Stock Compression and Decompression', LZString.compress, LZString.decompress, '')
runTestSet('Base64 Compression and Decompression', LZString.compressToBase64, LZString.decompressFromBase64, test_tattooBase64)
runTestSet('UTF16 Compression and Decompression', LZString.compressToUTF16, LZString.decompressFromUTF16, test_tattooUTF16)
runTestSet('Uint8Array Compression and Decompression', LZString.compressToUint8Array, LZString.decompressFromUint8Array, test_tattooUint8Array)
runTestSet('EncodedURIComponent Compression and Decompression', LZString.compressToEncodedURIComponent, LZString.decompressFromEncodedURIComponent, test_tattooEncodedURIComponentPlus)
